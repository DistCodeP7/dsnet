...
func (wm *WrapperManager) call(ctx context.Context, node string, action string) error {
...
func (wm *WrapperManager) parallel(ctx context.Context, nodes []string, action func(context.Context, string) error) map[string]error {
