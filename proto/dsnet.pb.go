...
var file_dsnet_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_dsnet_proto_goTypes = []any{
	(*Envelope)(nil), // 0: dsnet.Envelope
}
var file_dsnet_proto_depIdxs = []int32{
	0, // 0: dsnet.NetworkController.Stream:input_type -> dsnet.Envelope
	0, // 1: dsnet.NetworkController.Stream:output_type -> dsnet.Envelope
